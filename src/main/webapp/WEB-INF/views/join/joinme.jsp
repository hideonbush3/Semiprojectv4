...
<div id="main">
    ...
    <div class="card card-body bg-light mx-3 mt-5">
            ...
            <div class="row">
                ...
                <div class="col-11 offset-1 row mb-3 align-items-center">
                    ...
                    <div class="col-3">
                        <input
                                class="form-control border-danger"
                                type="text" name="userid" id="userid"></div>
                    <div class="col-auto">
                ...
                <div class="col-11 offset-1 row mb-3 align-items-center">
                    ...
                    <div class="col-3">
                        <input
                                class="form-control border-danger"
                                type="password" name="repasswd" id="repasswd"></div>
                    <div class="col-auto">
                ...
                <div class="col-11 offset-1 row mb-3 align-items-center">
                    <label class="col-2 form-label text-danger text-end"
                           for="zip1">우편번호</label>
                    <div class="col-1">
                        <input class="form-control border-danger bg-light" readonly
                               type="text" name="zip1" id="zip1"></div>
                    <div class="col-1">
                        <input class="form-control border-danger bg-light" readonly
                ...
                <div class="col-11 offset-1 row mb-3 align-items-center">
                    ...
                    <div class="col-4">
                        <input class="form-control border-danger"
                               type="text" name="addr2" id="addr2"></div>
                </div>
                ...
                <div class="modal-body">
                    <form name="zipfrm" id="zipfrm">
                        <div class="row mb-3 justify-content-center">
                            ...
                            <div class="col-3">
                                <button class="btn btn-primary" id="findzipbtn"
